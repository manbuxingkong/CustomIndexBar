    ...
    public IIndexBarDataHelper fillInexTag(List<? extends BaseIndexPinyinBean> datas) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (indexPinyinBean.isNeedToPinyin()) {
                ...
                if (indexPinyinBean.getBaseIndexPinyin().toString().length() > 1) {
...
//                    return -1;
//                } else if (lhs.getBaseIndexPinyin().compareTo(rhs.getBaseIndexPinyin()) == 0) {
//                    return 0;
//                } else {
//                    return -1;
//                }
